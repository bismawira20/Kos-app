            ...
            <div class="rounded-xl bg-white p-6 shadow ring-1 ring-gray-100">
                <form action="{{ route('kamar.store') }}" method="POST" class="space-y-5">
                    ...
                    <div>
                        ...
                        <x-text-input id="harga" name="harga" type="number" min="0" class="mt-1 block w-full" :value="old('harga')" required />
                    ...
                    <div class="grid gap-4 sm:grid-cols-2">
                        <div>
                            ...
                            <x-text-input id="lantai" name="lantai" type="number" min="0" class="mt-1 block w-full" :value="old('lantai')" />
                        </div>
                        <div>
                            <x-input-label for="kapasitas" value="Kapasitas orang" />
                            <x-text-input id="kapasitas" name="kapasitas" type="number" min="1" class="mt-1 block w-full" :value="old('kapasitas', 2)" />
                        </div>
                    </div>

                    <div>
                        <x-input-label for="fasilitas" value="Fasilitas (opsional)" />
                        <textarea id="fasilitas" name="fasilitas" rows="2" class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm" placeholder="WiFi, AC, kamar mandi dalam, ...">{{ old('fasilitas') }}</textarea>
                    </div>
