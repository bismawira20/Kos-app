                            ...
                            <td class="px-4 py-3 text-center">
                                <div class="flex justify-center gap-2 whitespace-nowrap">
                                    @if ($l->status === 'menunggu')
                                        ...
                                        {{-- Delete Modal --}}
                                        <dialog id="delete-kendala-{{ $l->id }}" class="w-full max-w-sm rounded-2xl p-0 shadow-2xl backdrop:bg-slate-900/50 border border-slate-100 overflow-hidden text-left whitespace-normal">
                                            <div class="p-6 text-center">
                                                ...
                                                <h3 class="text-lg font-bold text-slate-900 mb-2">Hapus Laporan Kendala</h3>
                                                <p class="text-sm text-slate-600 mb-6">Apakah Anda yakin ingin menghapus laporan kendala ini?</p>
                                                <div class="flex items-center justify-center gap-3">
                                                    <button type="button" onclick="document.getElementById('delete-kendala-{{ $l->id }}').close()" class="rounded-xl border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-50 transition active:scale-95">
                                                        Batal
                                                    </button>
