                    ...
                    <form action="{{ route('penghuni.store') }}" method="POST" class="space-y-5">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <x-text-input id="nama_wali" name="nama_wali" type="text" class="mt-1 block w-full" :value="old('nama_wali')" placeholder="Nama orang tua / wali" />
                                <x-input-error class="mt-2" :messages="$errors->get('nama_wali')" />
                            </div>
                            <div>
                                <x-input-label for="no_hp_wali" value="No. HP Wali" />
                                <x-text-input id="no_hp_wali" name="no_hp_wali" type="text" class="mt-1 block w-full" :value="old('no_hp_wali')" placeholder="62812..." />
